...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Create mouse trail particles when moving fast
      // if (isMouseDownRef.current) {
      //   createInteractiveParticles(mouseRef.current.x, mouseRef.current.y, 3);
      // }

      // create mouse trail particles when just moving
      createInteractiveParticles(mouseRef.current.x, mouseRef.current.y, 3);
    };
    ...
    //     createRipple(mouseRef.current.x, mouseRef.current.y, 100);
    //   }
    // };
    ...
    const drawOrbitalRings = () => {
      ...
      [150, 220, 300, 380, 480].forEach((radius, index) => {
        // Mouse proximity effect on rings
    ...
    const drawPlanets = () => {
      ...
      planetsRef.current.forEach((planet) => {
        ...
        // Draw enhanced trail when hovered
